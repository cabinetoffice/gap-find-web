...
const DatePickerDialog = function (cdp) {
  ...
  this.textboxNode = cdp.querySelectorAll('input');
...
DatePickerDialog.prototype.setTextboxDate = function (domNode) {
  ...
  this.textboxNode[0].value = d.getDate();
  this.textboxNode[1].value = d.getMonth() + 1;
  this.textboxNode[2].value = d.getFullYear();
...
DatePickerDialog.prototype.setDateForButtonLabel = function () {
  if (
    this.textboxNode.length === 3 &&
    Number.isInteger(parseInt(this.textboxNode[0])) &&
    Number.isInteger(parseInt(this.textboxNode[1])) &&
    Number.isInteger(parseInt(this.textboxNode[2]))
  ) {
    const day = new Date(
      this.textboxNode[2].value,
      this.textboxNode[0].value - 1,
      this.textboxNode[1].value,
    );
...
window.addEventListener('load', function () {
  const datePickers = document.querySelectorAll('.withDatePicker');

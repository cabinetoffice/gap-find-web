...
const linkToSignupText = 'Sign up and we will email you when new grants have been added.';
...
describe('NewsletterCallToAction', () => {
    it('should render with correct text and a clickable link', () => {
        ...
        expect(screen.getByText(linkToSignupText)).toHaveAttribute('href', '/newsletter?href=%2Fgrants');
    })
});

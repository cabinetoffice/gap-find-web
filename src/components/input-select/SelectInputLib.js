 ...
 */
const Select = function (el, options = [], onChange, initialValue) {
  // element refs
  this.el = el;
...
Select.prototype.init = function () {
  ...
  this.comboEl.innerHTML = this.options[0].field;
...
Select.prototype.createOption = function (option, index) {
  ...
  optionEl.innerText = option.field;
...
Select.prototype.selectOption = function (index) {
  ...
  const selected = this.options[index].field;
...
function initialize($el, options, onChange, initialValue) {
